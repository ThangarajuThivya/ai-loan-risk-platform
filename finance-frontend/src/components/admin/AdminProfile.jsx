...
// Admin has no self-editable profile fields today — PUT /user/profile is
// customer-only server-side, so name/email/phone are shown read-only here
// rather than behind a form that would silently fail to save. The one thing
// every role can genuinely self-serve is changing their own password.
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="flex items-start gap-2 bg-slate-50 border border-slate-100 rounded-xl px-3 py-2 text-[11px] text-slate-500">
        ...
        Editing your name, email, or phone isn't available from this page yet —
        contact your system administrator if these need to change.
      </div>
